...
export default function MenuCafeGhrib() {
  ...
  const categories = [
    ...
    { id: 'chicha', label: 'Chicha', image: 'chicha.jpg' },
    { id: 'jeux', label: 'Jeux de Carte', image: 'jeu de carte.jfif' },
    { id: 'offres', label: 'Nos Offres', image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=1000&q=80' },
  ];
  ...
  const produits = {
    ...
    jeux: [
      ...
      { nom: '1 Rami', prix: '2,000 DT' },
      { nom: '2 Rami', prix: '4,000 DT' },
    ],
    offres: [
      { nom: 'Chwaya filtre', prix: '' },
      { nom: 'Chwaya Tey', prix: '' },
      { nom: 'Chwaya Rosata', prix: '' },
    ],
  };
